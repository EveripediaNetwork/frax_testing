...
contract FraxUnifiedFarmTemplate is Owned, ReentrancyGuard {
    ...
    uint256 public lock_time_for_max_multiplier = 1 * 365 * 86400; // 3 years
...
contract FraxUnifiedFarm_ERC20 is FraxUnifiedFarmTemplate {
    ...
    mapping(bytes32 => uint256) public lockedStakeIdxByID;
...
// File contracts/Staking/Variants/FraxUnifiedFarm_ERC20_Fraxswap_FRAX_IQ.sol
